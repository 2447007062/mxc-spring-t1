package top.javaguo.core.cache.redis;
...
public class GuoRedisConfig extends CachingConfigurerSupport {


    /**
     * @Example 获取配置文件信息demo
     */
     ...
     * Logger
     */
    private static final Logger lg = LoggerFactory.getLogger(GuoRedisConfig.class);
	 ...
	 * 注入guoRedisUtil
	 */
	@Bean(name = "guoRedisUtil")
	public GuoRedisUtil guoRedisUtil(RedisTemplate<String, Object> redisTemplate) {
		GuoRedisUtil guoRedisUtil = new GuoRedisUtil();
		guoRedisUtil.setRedisTemplate(redisTemplate);
		return guoRedisUtil;
	}
}