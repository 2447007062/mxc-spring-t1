...
public class APIInterceptor implements HandlerInterceptor {
    ...
    public String[] getExcludeTokenUrl() {
        return PublicParamUtil.map.get("APIInterceptor_excludeTokenUrlAPI") == null ? new String[]{} : PublicParamUtil.map.get("APIInterceptor_excludeTokenUrlAPI").split(",");
    }

    /** 不需要验证权限的url **/
    public String[] getExcludeAuthUrl() {
        return PublicParamUtil.map.get("APIInterceptor_excludeAuthUrlAPI") == null ? new String[]{} : PublicParamUtil.map.get("APIInterceptor_excludeAuthUrlAPI").split(",");
    }
    /**
