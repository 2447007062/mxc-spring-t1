...
public class SystemInterceptor implements HandlerInterceptor {
    ...
    public boolean getValidateSignFlag() {
        return Boolean.valueOf(PublicParamUtil.map.get("SystemInterceptor_validateSignFlag"));
    }

    /** 是否验证令牌 **/
    public boolean getValidateTokenFlag() {
        return Boolean.valueOf(PublicParamUtil.map.get("SystemInterceptor_validateTokenFlag"));
    }

    /** 是否验证权限 **/
    public boolean getValidateAuthFlag() {
        return Boolean.valueOf(PublicParamUtil.map.get("SystemInterceptor_validateAuthFlag"));
    }

    /** 私有key **/
    public String getPrivateKey() {
        return PublicParamUtil.map.get("SystemInterceptor_privateKey");
    }

    /** 不需要验证token的url **/
    public String[] getExcludeTokenUrl() {
        return PublicParamUtil.map.get("SystemInterceptor_excludeTokenUrl") == null ? new String[]{} : PublicParamUtil.map.get("SystemInterceptor_excludeTokenUrl").split(",");
    }

    /** 不需要验证权限的url **/
    public String[] getExcludeAuthUrl() {
        return PublicParamUtil.map.get("SystemInterceptor_excludeAuthUrl") == null ? new String[]{} : PublicParamUtil.map.get("SystemInterceptor_excludeAuthUrl").split(",");
    }
